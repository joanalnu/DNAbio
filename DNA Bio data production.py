...
#por 1'000'000 y ver porcentaje de cambios en la amino säure
...
#create random single-mutation in DNA string, translating and comparing it
DNA = "TACCACGTGGACTGAGGACTCCTCATT"

for i in range (10):
    originalmRNA = DNAtoRNA(DNA)
    originalAmino = RNAtoAmino(originalmRNA)
    numberMutation = 1000000
    misssenseMutation = 0
